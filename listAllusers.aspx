<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="listAllusers.aspx.cs" Inherits="ceng382LabProject.listAllusers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
            ...
            <asp:GridView ID="ListAllUsersGridView"
                ...
                runat="server"
                OnSelectedIndexChanged="ListAllUsersGridView_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" Width="138px">
